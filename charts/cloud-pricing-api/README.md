...
![Version: 0.6.11](https://img.shields.io/badge/Version-0.6.11-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.3.18](https://img.shields.io/badge/AppVersion-0.3.18-informational?style=flat-square)
...
| job.image.repository | string | `"infracost/cloud-pricing-api"` | Cloud Pricing API image |
| job.image.tag | string | `""` | Overrides the image tag whose default is the chart appVersion. |
...
Due to the Bitnami PostgreSQL dependency upgrade if you have any secrets with the key `postgresql-password` you will need to update the key to `postgres-password`.
